  ...
  for(index=0;index<subtasks.length;index++){
   let tempobj={ 
     priority: subtasks[index].priority,
        tasktitle: subtasks[index].tasktitle,
        taskdiscription: subtasks[index].taskdiscription,
        
        taskDate: subtasks[index].taskDate,
   }
   taskobj.push(tempobj)

  }
  console.log(taskobj)
  
  updateTaskWithSubtask(taskid,taskobj)
}

/*
 function addsubTask(userId,taskid,subtaskobj){
